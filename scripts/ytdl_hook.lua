...
local tag_list = {
    ...
    -- ["description"]     = "ytdl_description", -- omitted: multi-line description breaks EDL demuxer
}
...
local function edl_escape(data)
...
local function tags_to_edl(json)
    ...
    for json_name, mp_name in pairs(tag_list) do
        if json_name ~= "ytdl_description" and json_name ~= "description" and mp_name ~= "ytdl_description" and mp_name ~= "description" then
