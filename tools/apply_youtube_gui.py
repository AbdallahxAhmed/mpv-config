...
ICON_FIRST_V6_CONTROLS = 'menu,command:content_paste:script-binding smart_paste/paste-to-open?Paste link,command:closed_caption:script-binding ytdl_sub_menu/open?Subtitles and captions,button:audio-tracks,<stream>button:stream-quality,<stream>button:download-video,button:stable-volume,loop-file,space,fullscreen'
NEW_CONTROLS = 'menu,command:content_paste:script-binding smart_paste/paste-to-open?Paste link,gap,command:closed_caption:script-binding ytdl_sub_menu/open?Subtitles and captions,button:audio-tracks,<has_many_video>video,<has_many_edition>editions,<stream>button:stream-quality,<stream>button:download-video,button:stable-volume,gap,space,<video,audio>speed,space,shuffle,loop-playlist,loop-file,gap,prev,items,next,space,fullscreen'
ACCEPTED_CONTROLS = (OLD_CONTROLS, PREVIOUS_CONTROLS, ICON_FIRST_V1_CONTROLS, ICON_FIRST_V2_CONTROLS, ICON_FIRST_V3_CONTROLS, ICON_FIRST_V4_CONTROLS, ICON_FIRST_V5_CONTROLS, ICON_FIRST_V6_CONTROLS)
REQUIRED_SCRIPTS = (
