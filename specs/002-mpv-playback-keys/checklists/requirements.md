# Specification Quality Checklist: MPV Playback Keys & Config Tuning
...
- The keybinding conflict table in US1 documents the exact current state from source code analysis.
